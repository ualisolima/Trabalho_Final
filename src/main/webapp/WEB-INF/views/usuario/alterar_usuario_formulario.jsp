...
<button class="dropbtn"><a href="/">Home</a></button>
	...
	<form action="alterarUsuario" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="id_papel" value="${usuario.id_papel}">
		...
		<c:url var="post_url"  value="/resources/images/usuario/${usuario.id_usuario}.jpg" />
		<input type="file" class="dropbtn" name="image" value="${post_url}" />
		<input type="submit" class="dropbtn" value="ALTERAR" /> 
	</form>
</body>
</html>