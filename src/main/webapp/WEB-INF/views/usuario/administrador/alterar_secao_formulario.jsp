...
<button class="dropbtn"><a href="/">Home</a></button>
	...
	<form action="alterarSecao" method="post"> 
		<table>
			<tr>
				<td>Título: </td>
				<input type="hidden" name="id_secao" value="${sec.id_secao}" />
				<td><input type="text" name="titulo" value="${sec.titulo}" /></td>
			</tr>
			<tr>
				<td>Descrição: </td>
				<td> <textarea style="resize:none" cols="50" rows="5" name="descricao">${sec.descricao}</textarea> <br /></td>
			</tr>
			<tr>
