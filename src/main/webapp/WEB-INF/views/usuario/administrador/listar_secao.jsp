...
<h2>Listar Seções</h2>
	...
	<c:forEach var="s" items="${secoes}">
		<tr>
			<td>${s.titulo}</td>
			<td>${s.descricao}</td>
			<td><button class="dropbtn"><a href="apagarSecao?id_secao=${s.id_secao}">APAGAR</a></button></td>
			<td><button class="dropbtn"><a href="alterarSecaoFormulario?id_secao=${s.id_secao}">ALTERAR</a></button></td>
		</tr>
	</c:forEach>
	</table>	
